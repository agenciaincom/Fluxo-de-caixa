...
import { LayoutDashboard, Bell, TrendingUp, TrendingDown, BarChart2, Camera, LogOut, Menu, Scale, BellRing } from "lucide-react";
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: "Configurações de Lembretes", href: "/configuracoes-lembretes", icon: BellRing },
  ];
